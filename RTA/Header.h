...
void DisplayAnimation(FbxScene* pScene)
{
	...
	{
		FbxAnimStack* lAnimStack = (FbxAnimStack*)pScene->GetSrcObject(i);
...
{
	int l;
	int nbAnimLayers = pAnimStack->GetMemberCount();
	...
	{
		FbxAnimLayer* lAnimLayer = (FbxAnimLayer*)pAnimStack->GetMember(l);
